                                ...
                                <td class="px-6 py-4 text-right">
                                    <?php if (!empty($member['Phone'])): ?>
                                        <a href="tel:<?= htmlspecialchars($member['Phone']) ?>"
                                            class="text-green-600 hover:text-green-700 transition-colors p-1 inline-block" title="Call Member">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none"
...
<script>
    ...
    async function handleEditSubmit(e) {
        ...
        // Stitch DOB FIRST (before FormData capture)
        ...
        // NOW create FormData (after DOB is set)
